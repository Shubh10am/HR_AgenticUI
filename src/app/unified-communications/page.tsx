...
const communicationPlatforms = [
  ...
  { name: 'Zoom', icon: Webcam, logoUrl: 'https://st2.zoom.us/static/6.3.38697/image/new/topNav/Zoom_logo.svg', dataAiHint: 'zoom app logo', description: 'Video calls and webinars.' },
  ...
  { name: 'GitHub', icon: Github, logoUrl: 'https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png', dataAiHint: 'github logo', description: 'Code collaboration and version control discussions.' },
];
